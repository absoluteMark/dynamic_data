            ...
            setTimeout(function () {
                if (data.status === 'success') {
                    ...
                    $.each(data.joined, function (index, val) {
                        ...
                        $('#' + div_target_id).append('<div onclick="selectGuest(' + val.contestant_id + ')" class="list-group-item list-group-item-action" data-toggle="list">' + val.contestant_name + '</div>');
                    });
...
function createContestant() {
    ...
    var data = $("#contestant-form").serialize();
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $('button#submitBtn3').html('Creating contestant ...').attr('disabled', 'disabled');
            $('button#closeBtn3').attr('disabled', 'disabled');
            ...
            setTimeout(function () {
                ...
                if (data.status === 'success') {
                    ...
                    $('#errorDiv3').slideDown(200, function () {
                        $('#errorDiv3').html('<div class="alert alert-info">' + data.message + '</div>')
                            .delay(3000).slideUp(100);
                        $("#contestant-form")[0].reset();
                    });
                } else {
                    $('#errorDiv3').slideDown(200, function () {
                        $('#errorDiv3').html('<div class="alert alert-danger">' + data.message + '</div>')
                            .delay(3000).slideUp(100);
                    });
                }

                $('button#submitBtn3').html('Create Another ?').removeAttr('disabled');
                $('button#closeBtn3').removeAttr('disabled');
